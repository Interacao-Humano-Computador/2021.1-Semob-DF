...
|---|
|Mais simplicidade, menos complicação|
|Ter um aplicativo para facilitar o uso|
|Ser mais objetivo e ter as opções mais vísiveis|

Entre as sugestões, dois participantes informaram que não tem sugestões por não usarem o site.
